      ...
      <div className="container">
          <div className="footer__left">
              ...
              <a className="footer__logo" href="./index.html">
                  <svg width="60" height="32" fill="none" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M31.347 26.122L15.673 0 0 26.122h31.347zM60.082 5.878L44.408 32 28.735 5.878h31.347z" fill="#fff"/></svg>
              </a>
              
              <nav className="nav nav-footer">
                  <ul className="nav__list nav__list-footer">
                      <li className="nav__item nav__item-footer">
                          <a className="nav__link nav__link--avtive-white nav__link-footer" href="#Home">home</a>
                      </li>
                      <li className="nav__item nav__item-footer">
                          <a className="nav__link nav__link-footer" href="#About">about us</a>
                      </li>
                      <li className="nav__item nav__item-footer">
                          <a className="nav__link nav__link-footer" href="#Plan">Create your plan</a>
                      </li>
                  </ul>
              </nav>
          </div>
